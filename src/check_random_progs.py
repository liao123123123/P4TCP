...
KNOWN_BUGS = [
    ...
    "table invocation in action argument",
    "Cannot evaluate initializer to a compile-time constant",
    "argument used for directionless parameter",
    "write set already set",
...
if __name__ == "__main__":
    ...
    print(f"timecost: {timeDifference}s"+"\n"+f"bug_count :{bug_count}");
