...
control ingress(inout Headers h) {
    ...
    @name("svHPQ") action svHPQ(@name("yfgx") bit<4> yfgx) {
        ...
        {
            @name("jWng_0") bit<64> jWng = vfedre_0;
        ...
        kSIZ = 8w42;
        {
            @name("val_0") bit<3> val = (bit<3>)kSIZ;
            @name("bound_0") bit<3> bound = 3w0;
    ...
    @name("svHPQ") action svHPQ_1(@name("yfgx") bit<4> yfgx_1) {
        vfedre_0 = 64w17991850652028935695;
        {
            @name("jWng_1") bit<64> jWng_4 = vfedre_0;
        ...
        kSIZ_2 = 8w42;
        {
            @name("val_1") bit<3> val_4 = (bit<3>)kSIZ_2;
            @name("bound_1") bit<3> bound_4 = 3w0;
    ...
    apply {
        ...
        {
            @name("val_2") bit<3> val_5 = tmp_1;
            @name("bound_2") bit<3> bound_5 = 3w0;
        ...
        switch (GdMfje_0.apply().action_run) {
            svHPQ: {
                ...
                FkqZfe_0.apply();
                {
                    @name("val_3") bit<3> val_6 = 3w2;
                    @name("bound_3") bit<3> bound_6 = 3w0;
                ...
                {
                    @name("jWng_2") bit<64> jWng_5 = Gxorez_0;
        ...
        IGknYG_0 = 64w0;
        {
            @name("jWng_3") bit<64> jWng_6 = IGknYG_0;
