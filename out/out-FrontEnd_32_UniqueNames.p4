...
control ingress(inout Headers h) {
    @name("rXrCFW") bool rXrCFW_0 = false;
    @name("ZKpTNg") bit<4> ZKpTNg_0 = (bit<4>)h.eth_hdr.eth_type;
    ...
    @name("svHPQ") action svHPQ_0(bit<4> yfgx) {
        ...
        {
            @name("vfedre") bit<64> vfedre_0 = 64w17991850652028935695;
    ...
    apply {
        ...
        switch (GdMfje_0.apply().action_run) {
            svHPQ_0: {
                ...
                {
                    @name("Gxorez") bit<64> Gxorez_0 = 64w10818472500171495232 ^ (bit<64>)h.eth_hdr.src_addr;
        ...
        ZKpTNg_0 = ZKpTNg_0;
        {
            @name("IGknYG") bit<64> IGknYG_0 = 64w0;
            ccWCqtG(IGknYG_0, 64w17525661711656856981);
        }
        ZKpTNg_0 = 4w3;
        h.zEXs.eth_type = 16w12364;
        @name("CRcSlO") bit<128> CRcSlO_0 = (bit<128>)ZKpTNg_0;
